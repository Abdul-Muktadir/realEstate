              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('properties.edit', $property->id) }}" class="btn btn-default">Edit</a>
                    </td>
                    <td>
                        {!! Form::open(['action' => ['App\Http\Controllers\Admin\PropertiesController@destroy', $property->id], 'method' => 'POST', 'class' => 'pull-right']) !!}
