...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
        <a href="/admin" class="nav-link {{$current_route == '/admin' ? 'active': ''}}">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="/adminvendors/create" class="nav-link">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{url('/adminvendors')}}" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/adminproperties')}}" class="nav-link">
